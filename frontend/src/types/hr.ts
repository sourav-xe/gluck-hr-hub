...
export interface Employee {
  id: string;
  /** Display / payslip id: GG001, GG002, … (assigned on create). */
  employeeCode?: string;
  fullName: string;
  email: string;
  phone: string;
  ...
  /** Portal role from linked User (GET `/api/employees/:id` only). */
  appRole?: UserRole;
  /** Custom sidebar keys; null/omit = use role defaults only. */
