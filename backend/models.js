...
const employeeSchema = new mongoose.Schema(
  {
    ...
    /** Human-readable id for payslips / UI: GG001, GG002, … (Mongo _id stays the system key). */
    employeeCode: { type: String, default: undefined },
    /**
     * Optional per-user sidebar restriction (Super Admin only). If unset, nav follows `app_role` only.
     * Array of nav keys: dashboard, payroll, documents, …
     */
    sidebarNavAllow: { type: [String], default: undefined },
  },
  { timestamps: true }
);
      ...
      type: [
        {
          ...
          /** Short form label for the form (e.g. "Candidate name") — set once at upload. */
          label: { type: String, default: '' },
        },
      ],
      default: () => [],
