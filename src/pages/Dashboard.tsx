  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <StatCard title="Attendance %" value={`${attendancePct}%`} icon={<CalendarCheck className="w-5 h-5" />} subtitle="Today" gradient="bg-gradient-to-br from-success to-info" href="/attendance" />
        ...
        <StatCard title="Documents" value={docsThisMonth} icon={<FileText className="w-5 h-5" />} subtitle="This month" gradient="bg-gradient-to-br from-info to-primary" href="/documents" />
      </div>
