...
import { fetchPayrollRecordById } from '@/lib/hrApi';
        ...
        <div className="border border-border/50 rounded-xl overflow-hidden mb-6">
          ...
          <div className="divide-y divide-border/50">
            <div className="flex justify-between px-4 py-3 text-sm">
              ...
              <span className="font-mono font-semibold">LKR {record.baseSalary.toLocaleString()}</span>
            </div>
            <div className="flex justify-between px-4 py-3 text-sm">
              <span>Bonus</span>
              <span className="font-mono text-success">+ LKR {record.bonus.toLocaleString()}</span>
            </div>
            <div className="flex justify-between px-4 py-3 text-sm">
              <span>Leave Deductions</span>
              <span className="font-mono text-destructive">- LKR {record.leaveDeductions.toLocaleString()}</span>
            </div>
          </div>
          <div className="flex justify-between px-4 py-3 bg-primary/5 font-bold">
            <span>Net Payable</span>
            <span className="font-mono">LKR {record.netPayable.toLocaleString()}</span>
          </div>
        </div>
